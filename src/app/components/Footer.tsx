      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-lg font-semibold text-white mb-4">Future of Blockchain Research Initiative</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold text-white mb-4 uppercase tracking-wide">Research Areas</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/business-case" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Business Case Study
                </a>
              </li>
              <li>
                <a href="/#analysis" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Comparative Analysis
                </a>
              </li>
              <li>
                <a href="/#methodology" className="text-gray-400 hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-400">
                <a href="mailto:research@futureofblockchain.website" className="hover:text-blue-400 transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400 mb-4 md:mb-0">
              <p>&copy; 2025 Future of Blockchain Research Initiative. All rights reserved.</p>
        ...
        <div className="mt-8 p-4 bg-gray-900 rounded-lg border border-gray-700">
          <h5 className="text-sm font-semibold text-white mb-2">Research Disclaimer</h5>
