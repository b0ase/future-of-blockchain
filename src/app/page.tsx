...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 border-b border-gray-800 overflow-hidden">
        <SimpleHero />
        <div className="relative z-10 container mx-auto px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/visualization"
                className="bg-gray-900/90 backdrop-blur-sm text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-all duration-300 shadow-lg border border-gray-700"
              >
                3D Visualization
              </a>
              <a
              ...
              <a
                href="/business-case"
                className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 text-gray-300 px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-all duration-300 shadow-lg"
              >
                Business Case Study
              </a>
            </div>
      ...
      <section className="py-12 bg-gray-900">
        <div className="container mx-auto px-6">
          <h2 className="text-2xl font-bold text-white mb-8 text-center">Research Overview</h2>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-bold text-white mb-4">Explore Blockchain Architecture</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="data-card">
                ...
                <p className="text-sm text-gray-400">Visualize global hash rate distribution across major mining pools</p>
              </div>
              <div className="data-card">
                <div className="text-3xl mb-3">⏰</div>
                <h3 className="text-lg font-semibold text-white mb-2">Block Timeline</h3>
                <p className="text-sm text-gray-400">Watch blockchain evolution from 1MB to 20GB blocks over 17 years</p>
              </div>
              <div className="data-card">
                <div className="text-3xl mb-3">🔍</div>
                <h3 className="text-lg font-semibold text-white mb-2">Interactive Exploration</h3>
                <p className="text-sm text-gray-400">Orbit, zoom, and explore blockchain architecture in real-time</p>
              </div>
            </div>

            <a
              href="/visualization"
              className="inline-flex items-center bg-gray-900 text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-all transform hover:scale-105 shadow-lg border border-gray-700"
            >
      ...
      <section className="py-16 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Research Objectives</h2>
            
            <div className="research-section">
              <h3 className="text-xl font-semibold text-white mb-6">Understanding Blockchain Evolution</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="data-card">
                  <h4 className="font-semibold text-blue-400 mb-3">Technical Analysis</h4>
                ...
                <div className="data-card">
                  <h4 className="font-semibold text-green-400 mb-3">Economic Analysis</h4>
                  <ul className="text-sm text-gray-400 space-y-2">
      ...
      <section id="analysis" className="py-16 bg-gray-900">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Comparative Analysis</h2>
      ...
      <section className="py-16 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-12 text-center">Key Research Findings</h2>
            
            <div className="grid md:grid-cols-3 gap-8">
              <div className="data-card">
                <h3 className="text-lg font-semibold text-white mb-4">Scalability Trade-offs</h3>
              ...
              <div className="data-card">
                <h3 className="text-lg font-semibold text-white mb-4">Cost Structures</h3>
                <div className="space-y-3 text-sm text-gray-400">
                  <div className="flex justify-between">
              ...
              <div className="data-card">
                <h3 className="text-lg font-semibold text-white mb-4">Adoption Patterns</h3>
                <div className="space-y-3 text-sm text-gray-400">
                  <div className="flex justify-between">
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Bitcoin Transaction Cost Evolution</h2>
            ...
            <div className="mt-8 p-6 bg-yellow-900/20 rounded-lg border border-yellow-800">
              <h3 className="text-lg font-semibold text-yellow-400 mb-3">Research Observation</h3>
      ...
      {/* Methodology */}
      <section id="methodology" className="py-16 bg-black">
        <div className="container mx-auto px-6">
          <MethodologySection
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Regulatory Landscape Analysis</h2>
            
            <div className="research-section">
              <h3 className="text-xl font-semibold text-white mb-6">Classification and Compliance</h3>
              
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-green-400 mb-3">Commodity Classification</h4>
                  <ul className="text-sm text-gray-400 space-y-2">
                ...
                <div>
                  <h4 className="font-semibold text-yellow-400 mb-3">Uncertain Classification</h4>
                  <ul className="text-sm text-gray-400 space-y-2">
                    <li>• Ethereum (ETH)</li>
                    <li>• Solana (SOL)</li>
      ...
      <section className="py-16 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Open Research Questions</h2>
            
            <div className="space-y-6">
              <div className="data-card">
                <h3 className="text-lg font-semibold text-white mb-3">Scalability vs. Decentralization</h3>
              ...
              <div className="data-card">
                <h3 className="text-lg font-semibold text-white mb-3">Network Effect Dynamics</h3>
                <p className="text-gray-400 text-sm">
              ...
              <div className="data-card">
                <h3 className="text-lg font-semibold text-white mb-3">Regulatory Evolution</h3>
                <p className="text-gray-400 text-sm">
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Explore the Future of Blockchain</h2>
