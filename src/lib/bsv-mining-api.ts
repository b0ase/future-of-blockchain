...
// Fallback static data if APIs are unavailable
export const fallbackBSVPools: MiningPool[] = [
  { name: 'TAAL', percentage: 38.0, color: '#FF0000' },
  { name: 'QDLink', percentage: 28.0, color: '#FF3300' },
  { name: 'CUUVE', percentage: 12.0, color: '#FF6600' },
  { name: 'Mining Dutch', percentage: 8.0, color: '#FF9900' },
  { name: 'GorillaPool', percentage: 5.0, color: '#FFCC00' },
  { name: 'Unknown', percentage: 3.0, color: '#FFFF00' },
  { name: 'ViaBTC', percentage: 2.5, color: '#CCFF00' },
  { name: 'SVPool', percentage: 2.0, color: '#99FF00' },
  { name: 'F2Pool', percentage: 1.0, color: '#66FF00' },
  { name: 'Other', percentage: 0.5, color: '#33FF00' }
];
